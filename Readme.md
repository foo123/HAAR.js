...
*haarcascades_frontalface_alt*  (works in browser and Node)
...
The structure of the .js and .json formats are exactly the same, so you can interchange between the two freely
...
so make sure to re-convert your xml cascades for this version of HAAR.js
