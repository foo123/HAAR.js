"use strict";
var fs = require('fs'),
  HAAR = require('../build/haar-detector.js'),
  detector = require('../cascades/haarcascade_frontalface_alt.js')/*JSON.parse(fs.readFileSync(__dirname + '/../cascades/haarcascade_frontalface_alt.json', 'utf8'))*/;
...
fs.readFile(__dirname + '/model1.jpg', function(error, buffer) {
