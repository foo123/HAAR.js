...
this.Ratio=0.5;this.ImageChanged=!1;this.cannyLow=20;this.cannyHigh=100;this.Parallel=e||!1;this.onComplete=null};n.Detector.prototype={haardata:null,objects:null,Selection:null,Ready:!1,image:function(a,e,i){if(a)this.Canvas=i||document.createElement("canvas"),this.Ratio=typeof e=="undefined"?0.5:e,this.Async=!0,this.Ready=!1,this.origWidth=a.width,this.origHeight=a.height,this.width=this.Canvas.width=r(this.Ratio*a.width),this.height=this.Canvas.height=r(this.Ratio*a.height),this.Canvas.getContext("2d").drawImage(a,
0,0,a.width,a.height,0,0,this.width,this.height),this.ImageChanged=!0;return this},interval:function(a){if(a>0)this.DetectInterval=a;return this},cannyThreshold:function(a){a&&"undefined"!=typeof a.low&&(this.cannyLow=a.low);a&&"undefined"!=typeof a.high&&(this.cannyHigh=a.high);return this},selection:function(){var a=Array.prototype.slice.call(arguments);this.Selection=1==a.length&&"auto"==a[0]||!a.length?null:n.Feature.prototype.data.apply(new n.Feature,a);return this},complete:function(a){this.onComplete=
a;return this},detect:function(a,e,i,g,h){var b=this,j=b.haardata.size1,f=b.haardata.size2;if(!b.Selection)b.Selection=new n.Feature(0,0,b.origWidth,b.origHeight);b.Selection.x="auto"==b.Selection.x?0:b.Selection.x;b.Selection.y="auto"==b.Selection.y?0:b.Selection.y;b.Selection.width="auto"==b.Selection.width?b.origWidth:b.Selection.width;b.Selection.height="auto"==b.Selection.height?b.origHeight:b.Selection.height;b.scaledSelection=b.Selection.clone().scale(b.Ratio).round();a=typeof a=="undefined"?
1:a;e=typeof e=="undefined"?1.25:e;i=typeof i=="undefined"?0.1:i;g=typeof g=="undefined"?1:g;b.doCannyPruning=typeof h=="undefined"?!0:h;if(this.ImageChanged)h=K(b.Canvas),b.canny=b.doCannyPruning?L(h.gray,b.width,b.height):null,b.integral=h.integral,b.squares=h.squares,h=null;this.ImageChanged=!1;b.maxScale=N(b.width/j,b.height/f);b.scale=a;b.min_neighbors=g;b.scale_inc=e;b.increment=i;b.Ready=!1;if(b.Parallel&&b.Parallel.isSupported()){j=[];for(f=0;a<=b.maxScale;a*=e)j.push({haardata:b.haardata,
